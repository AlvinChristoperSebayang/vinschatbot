...
def preprocess_text(text, language):
    ...
    if language == 'en':
        ...
        stop_words = set()
        language_text = "bahasa tidak terdeteksi"
...
# # Menggabungkan data latih dengan topik yang sama
# combined_training_data = {}
# for text, label in training_data:
#     if label not in combined_training_data:
#         combined_training_data[label] = []
#     combined_training_data[label].append(text)

# # Hasil penggabungan data latih
